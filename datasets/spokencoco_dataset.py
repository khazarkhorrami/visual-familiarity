...
class ImageCaptionDataset(Dataset):
    ...
    def __init__(self, args, split = "train"):
        ...
        if split == "train":
            ...
            audio_dataset_json_file = '/scratch/project_2001315/khazar_projects/FaST/data/SpokenCOCO_train_sub2_unrolled_karpathy.json'
            ...
            if self.args.test:
                ...
                audio_dataset_json_file = '/scratch/project_2001315/khazar_projects/FaST/data/SpokenCOCO_val_sub2_unrolled_karpathy.json'
